    ...
    <Layout>
      <div className="about__content">
        ...
        <p>
          ...
          served to us in a way that will align to our interests. And sometimes
          that is a good thing. But sometimes it can surround us in a cocoon
          without us even knowing. This cocoon has many names such as
          confirmation bias or echo chambers. Places where our information is
          aligned to a common understanding and any deviation from that idea is
        ...
        <p>
          ...
          presented to you is also being presented for you. Purposefully search
          for opposing points of view. Use other sources of information such as
          friends, libraries and academics. Follow people who challenge your
          perspectives. Engage in conversations with them and may you'll teach
          and learn something.
        </p>
        <p>
          Enjoy the convenience that algorithms provide, while also being aware
          that the things they provide may not be the entire truth.
        </p>
      </div>
